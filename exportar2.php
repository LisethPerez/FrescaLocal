...
$dump = 'mysqldump --routines --events --opt -h' .$servidor .' -u' .$username.' -p' .$password .' ' .$db .' cargo_modulo categoria_cliente categoria_producto_trans cliente empleado modulos password_resets sede stock tipo_cargo tipo_cuenta tipo_pago --no-tablespaces> ' .$salida_sql; 
